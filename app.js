...
function moreAboutHome(a,b,c){
    ...
    var temp2 = typeof(b) ;
    var temp3 = typeof(c) ;
    var res = temp1+temp2+temp3;
    return res;
}
var address = "forest";
var distanceFromTown = "far";
var hasNeighbours = "No";
...
// var parents="HaroldLily";
// var noOfSiblings = 2;
//var isNuclearFamily = true;
...
function sweetTooth(totalNoOfSweets,sweetsConsumedByKaren,sweetsConsumedInNMeters,metersToTravel)
{
   ...
   if( typeof totalNoOfSweets != "number" || typeof sweetsConsumedByKaren != "number" || typeof sweetsConsumedInNMeters != "number" || typeof metersToTravel != "number"){
        return "There is no sweet";
   }
   else{
        temp =(totalNoOfSweets -(sweetsConsumedByKaren + sweetsConsumedInNMeters * metersToTravel))/2 
        return temp;
    }
}
...
function aDifficultChoice(choice){
    switch(choice){
        ...
        case 3: return "Counsel her daughter herself";
                break;
        default:return "Lock her daughter in her room";
